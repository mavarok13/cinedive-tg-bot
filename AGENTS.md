...
- Search is wired to TMDB and persists selected media cards. Wishlist, watched, and rating flows are implemented. Recommendation, mood, and soundtrack handlers are intentionally placeholders until the next MVP stages.
