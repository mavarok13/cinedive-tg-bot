...
- Search is wired to TMDB and persists selected media cards. Wishlist, watched, rating, mood, and simple recommendation flows are implemented. Soundtrack handlers are intentionally placeholders until the next MVP stage.
